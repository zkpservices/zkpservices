...
export function OnboardToNewChainModal({ open, onClose, 
  ...
  const handleSubmit = async () => {
    ...
    const batchSignUpContract = targetChainId == 43113 ? fujiBatchSignUpContract :
      targetChainId == 80001 ? mumbaiBatchSignUpContract :
                ...
                <div className="sm:flex sm:items-start">
                  ...
                  <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                    ...
                    <div className="mt-2 lg:max-h-[65vh] max-h-[40vh] overflow-y-auto">
                      <div className="m-2">
                        <label htmlFor="chain" className="block text-sm font-medium leading-6 text-gray-900 dark:text-white">
                          Select Chain:
                        </label>
                        <select
                          id="chain"
