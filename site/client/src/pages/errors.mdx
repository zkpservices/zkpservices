export const description =
  'In this guide, we will discuss what happens when something goes wrong while you work with the API.'

# Errors

In this guide, we will discuss what happens when something goes wrong while you work with the API. Mistakes happen, and mostly, they will be yours, not ours. Let's look at some status codes and error types you might encounter. {{ className: 'lead' }}
...
<Properties>
  ...
  <Property name="5xx">
    A 5xx status code indicates a server error — you won't see these.
  </Property>
</Properties>
