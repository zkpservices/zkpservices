...
template ZKPServicesVRF2FAResponse () {
  
    /* Example input.json
    {
        "random_number": "1264123497132496213126416432197643912874311293612987431264",
...
component main { public [ random_number, secret_hash ] } = ZKPServicesVRF2FAResponse();
